  ...
  <body>
    <div class="container-fluid contenedor">
        <section class="contenedorMenus">      
            ...
            <div class="paginas">
                <ul class="menus">
                    <li><h3><a href="inicio.php">Inicio</a></h3></li>
                    <li><h3><a href="">Notificaciones</a></h3></li>
                    <li><h3><a href="">Mensajes</a></h3></li>
                    <li><h3><a href="">Destacados</a></h3></li>
        ...
        <section class=" contenedorPosteos">
            ...
            <div class="posteos">
                ...
                <div class="boton"> <!-- porque no aparece el boton? -->
